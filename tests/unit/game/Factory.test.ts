...
import {
  ...
  expectBeltSegments,
  renderGrid,
} from '../helpers/factoryAssert'
import { Factory, getSlotPositions, slotPositionToOffset, hasLShapeAtEndpoints } from '../../../src/game/Factory'
import type { GridPosition, SlotPosition, MachineType } from '../../../src/game/types'
...
describe('Factory', () => {
  ...
  describe('cellHasBeltsExcluding()', () => {
    ...
    it('should return true when cell has belts and no exclusion set', () => {
      ...
      factory.placeMachine(1, 4, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 1, z: 4 },
            path: [{ x: 1, z: 1 }, { x: 1, z: 2 }, { x: 1, z: 3 }, { x: 1, z: 4 }],
          },
        ],
      })
    ...
    it('should return true when cell has non-excluded belts', () => {
      ...
      factory.placeMachine(3, 4, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| |A| | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 3, z: 1 },
            destination: { x: 3, z: 4 },
            path: [{ x: 3, z: 1 }, { x: 3, z: 2 }, { x: 3, z: 3 }, { x: 3, z: 4 }],
          },
        ],
      })
  ...
  describe('clear()', () => {
    it('should remove all machines and belts', () => {
      ...
      expectFactoryState(factory, {
        ...
        machines: [
          ...
          { x: 3, z: 0, rotation: 'south' },
        ],
        belts: [
          {
            source: { x: 2, z: 0 },
            destination: { x: 3, z: 0 },
            path: [{ x: 2, z: 0 }, { x: 3, z: 0 }],
          },
        ],
      })
    ...
    it('should allow placing again after clear', () => {
      ...
      // WHEN + THEN
      expect(factory.placeMachine(0, 0, 'painter', 'south')).toBeTruthy()
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '|P| | | | |',
            '| | | | | |',
  ...
  describe('computeBeltFromSlotPath()', () => {
    ...
    it('should return a non-colliding path between two machines', () => {
      ...
      factory.placeMachine(5, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
    ...
    it('should return collides=true when path is blocked', () => {
      ...
      // THEN — path is fully blocked: no route exists. The planner may either
      // return null (no path geometrically possible) or a colliding plan.
      if (result !== null) {
    ...
    it('should respect ignoreBeltIds parameter', () => {
      ...
      factory.placeMachine(1, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
    ...
    it('should produce adjacent path segments', () => {
      ...
      factory.placeMachine(6, 6, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
  ...
  describe('findBestBeltPath()', () => {
    ...
    it('should return Z-first path when X-first collides but Z-first does not', () => {
      ...
      factory.placeMachine(4, 4, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      factory.placeMachine(3, 1, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| |R| | | | | | |',
    ...
    it('should respect ignoreBeltIds parameter', () => {
      ...
      factory.placeMachine(4, 1, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | |P| | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 4, z: 1 },
            path: [{ x: 1, z: 1 }, { x: 2, z: 1 }, { x: 2, z: 0 }, { x: 3, z: 0 }, { x: 4, z: 0 }, { x: 4, z: 1 }],
          },
        ],
      })
    ...
    it('should use BFS to route around obstacles', () => {
      ...
      factory.placeMachine(3, 0, 'recycler', 'south')   // blocks X-first
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | |R| | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(0, 3, 'recycler', 'south')   // blocks Z-first
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | |R| | | | | | |',
            '| | | | | | | | | | |',
  ...
  describe('getBelts()', () => {
    it('should return all placed belts', () => {
      ...
      factory.placeMachine(0, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '|A| | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(0, 6, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '|A| | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 0, z: 0 },
            destination: { x: 0, z: 3 },
            path: [{ x: 0, z: 0 }, { x: 0, z: 1 }, { x: 0, z: 2 }, { x: 0, z: 3 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 0, z: 3 },
            destination: { x: 0, z: 6 },
            path: [{ x: 0, z: 3 }, { x: 0, z: 4 }, { x: 0, z: 5 }, { x: 0, z: 6 }],
          },
        ],
      })
  ...
  describe('getBeltsAt()', () => {
    it('should return belts connected to a position', () => {
      // GIVEN — three machines spaced apart, connected by belt chains
      factory = createTestFactory(10, 10)
      factory.placeMachine(1, 0, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| |A| | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(1, 6, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| |A| | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 0 },
            destination: { x: 1, z: 3 },
            path: [{ x: 1, z: 0 }, { x: 1, z: 1 }, { x: 1, z: 2 }, { x: 1, z: 3 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 1, z: 3 },
            destination: { x: 1, z: 6 },
            path: [{ x: 1, z: 3 }, { x: 1, z: 4 }, { x: 1, z: 5 }, { x: 1, z: 6 }],
          },
        ],
      })
  ...
  describe('getConnectedBeltIds()', () => {
    ...
    it('should return correct belt IDs for a single chain', () => {
      ...
      expectBeltSegments(factory, [seg(1, 1, 2, 1), seg(2, 1, 2, 0), seg(2, 0, 3, 0), seg(3, 0, 4, 0), seg(4, 0, 4, 1)])
    ...
    it('should return belt IDs from multiple chains connected to one machine', () => {
      ...
      factory.placeMachine(3, 0, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | |P| | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(6, 3, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | |P| | | | | | |',
            '| | | | | | | | | | |',
      ...
      expectBeltSegments(factory, [seg(3, 3, 4, 3), seg(4, 3, 4, 2), seg(4, 2, 5, 2), seg(5, 2, 6, 2), seg(6, 2, 6, 3)])
    ...
    it('should return only belts connected to the queried machine', () => {
      // GIVEN — two independent belt chains pre-built via restoreState to
      // bypass slot-blocking constraints in the corner placements
      factory.restoreState([
        { x: 0, z: 0, type: 'assembler', rotation: 'east' },
        { x: 3, z: 0, type: 'painter', rotation: 'east' },
        { x: 0, z: 5, type: 'assembler', rotation: 'east' },
        { x: 3, z: 5, type: 'painter', rotation: 'east' },
      ], [
        {
          sourceSlot: 'front',
        ...
        },
        {
          sourceSlot: 'front',
          destinationSlot: 'back',
          path: [{ x: 0, z: 5 }, { x: 1, z: 5 }, { x: 2, z: 5 }, { x: 3, z: 5 }],
        },
      ])
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
        ...
        machines: [
          ...
          { x: 3, z: 0, rotation: 'east' },
          { x: 0, z: 5, rotation: 'east' },
      ...
      expectBeltSegments(factory, [seg(0, 0, 1, 0), seg(1, 0, 2, 0), seg(2, 0, 3, 0), seg(0, 5, 1, 5), seg(1, 5, 2, 5), seg(2, 5, 3, 5)])
  ...
  describe('getConnectedMachines()', () => {
    ...
    it('should return empty array for machine with no belts', () => {
      // GIVEN
      factory.placeMachine(3, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should return multiple connected machines for hub machine', () => {
      // GIVEN
      factory.placeMachine(5, 5, 'splitter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(8, 5, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should report correct machineIsSource for mixed source/dest connections', () => {
      ...
      factory.placeMachine(1, 1, 'assembler', 'south')   // A
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      factory.placeMachine(1, 5, 'part_fabricator', 'south') // B
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      factory.placeMachine(1, 8, 'painter', 'south')      // C
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 1, z: 5 },
            destination: { x: 1, z: 8 },
            path: [{ x: 1, z: 5 }, { x: 1, z: 6 }, { x: 1, z: 7 }, { x: 1, z: 8 }],
          },
        ],
      })
  ...
  describe('getFreeSlotsOfType()', () => {
    ...
    it('should return remaining free slots after one is connected', () => {
      ...
      factory.placeMachine(3, 7, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 3, z: 7 },
            path: [{ x: 3, z: 3 }, { x: 3, z: 4 }, { x: 3, z: 5 }, { x: 3, z: 6 }, { x: 3, z: 7 }],
          },
        ],
      })
  ...
  describe('hasBeltSegment()', () => {
    ...
    it('should still find segments from non-ignored belts', () => {
      ...
      factory.placeMachine(5, 4, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | |A| | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 5, z: 1 },
            destination: { x: 5, z: 4 },
            path: [{ x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }],
          },
        ],
      })
  ...
  describe('moveMachine()', () => {
        ...
        belts: [
          {
            source: { x: 3, z: 0 },
            destination: { x: 1, z: 3 },
            path: [{ x: 3, z: 0 }, { x: 3, z: 1 }, { x: 2, z: 1 }, { x: 1, z: 1 }, { x: 1, z: 2 }, { x: 1, z: 3 }],
          },
        ],
      })
    ...
    it('should reconnect belt chains to connected machines after move', () => {
      ...
      factory.placeMachine(2, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 2, z: 5 },
            path: [{ x: 2, z: 2 }, { x: 2, z: 3 }, { x: 2, z: 4 }, { x: 2, z: 5 }],
          },
        ],
      })
      expectBeltSegments(factory, [
        ...
        belts: [
          {
            source: { x: 4, z: 2 },
            destination: { x: 2, z: 5 },
            path: [{ x: 4, z: 2 }, { x: 4, z: 3 }, { x: 3, z: 3 }, { x: 2, z: 3 }, { x: 2, z: 4 }, { x: 2, z: 5 }],
          },
        ],
      })
    ...
    it('should drop belt chain if reconnection would collide', () => {
      ...
      factory.placeMachine(5, 3, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      factory.placeMachine(5, 0, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | |A| | | | |',
            '| |A| | | | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 5, z: 0 },
            destination: { x: 5, z: 3 },
            path: [{ x: 5, z: 0 }, { x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 6, z: 1 },
            destination: { x: 1, z: 4 },
            path: [{ x: 6, z: 1 }, { x: 6, z: 2 }, { x: 6, z: 3 }, { x: 6, z: 4 }, { x: 5, z: 4 }, { x: 4, z: 4 }, { x: 3, z: 4 }, { x: 2, z: 4 }, { x: 2, z: 3 }, { x: 1, z: 3 }, { x: 1, z: 4 }],
          },
        ],
      })
    ...
    it('should preserve belt direction when target machine is moved', () => {
      // GIVEN
      factory = createTestFactory(10, 10)
      factory.placeMachine(2, 2, 'assembler', 'south')  // source
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(2, 5, 'painter', 'south')    // target
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 4, z: 5 },
            path: [{ x: 2, z: 2 }, { x: 2, z: 3 }, { x: 3, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 4 }, { x: 4, z: 5 }],
          },
        ],
      })
    ...
    it('should preserve belts not connected to the moved machine', () => {
      ...
      factory.placeMachine(5, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '|A| | | | |A| | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(5, 6, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '|A| | | | |A| | | | |',
            '| | | | | | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 5, z: 3 },
            destination: { x: 5, z: 6 },
            path: [{ x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }, { x: 5, z: 6 }],
          },
        ],
      })
  ...
  describe('moveMachine() preserves rotations during reconnection', () => {
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 5, z: 5 },
            path: [{ x: 3, z: 5 }, { x: 3, z: 6 }, { x: 4, z: 6 }, { x: 4, z: 5 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 6, z: 5 },
            path: [{ x: 3, z: 5 }, { x: 3, z: 6 }, { x: 4, z: 6 }, { x: 5, z: 6 }, { x: 5, z: 5 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 6, z: 5 }],
          },
        ],
      })
    ...
    it('should fall back to rotation only when fixed-rotation path is impossible', () => {
      ...
      const a = factory.placeMachine(1, 1, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 11, 11], expected: [
            '| | | | | | | | | | | | |',
            '| |F| | | | | | | | | | |',
      ...
      const b = factory.placeMachine(2, 1, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 11, 11], expected: [
            '| | | | | | | | | | | | |',
            '| |F|F| | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 2, z: 1 },
            path: [{ x: 1, z: 1 }, { x: 1, z: 2 }, { x: 2, z: 2 }, { x: 3, z: 2 }, { x: 3, z: 1 }, { x: 3, z: 0 }, { x: 2, z: 0 }, { x: 2, z: 1 }],
          },
        ],
      })
      ...
      factory.placeMachine(0, 0, 'recycler', 'south') // blocker at target
      expectFactoryState(factory, {
        grid: { box: [0, 0, 11, 11], expected: [
            '|R| |┌|┐| | | | | | | | |',
            '| |F|F|│| | | | | | | | |',
      ...
      factory.placeMachine(0, 2, 'recycler', 'south') // blocker below
      expectFactoryState(factory, {
        grid: { box: [0, 0, 11, 11], expected: [
            '|R| |┌|┐| | | | | | | | |',
            '| |F|F|│| | | | | | | | |',
      ...
      factory.placeMachine(1, 2, 'recycler', 'south') // blocker below A
      expectFactoryState(factory, {
        grid: { box: [0, 0, 11, 11], expected: [
            '|R| |┌|┐| | | | | | | | |',
            '| |F|F|│| | | | | | | | |',
  ...
  describe('placeBelt()', () => {
    ...
    it('should fail when slot is already occupied', () => {
      ...
      factory.placeMachine(2, 6, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should fail when slot cells are not adjacent', () => {
      ...
      factory.placeMachine(2, 6, 'assembler', 'south') // too far apart
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
  ...
  describe('placeBeltChain()', () => {
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 4, z: 4 },
            path: [{ x: 1, z: 1 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 4, z: 2 }, { x: 4, z: 3 }, { x: 4, z: 4 }],
          },
        ],
      })
    ...
    it('L-shaped -X then -Z: source faces -X (270°), target faces -Z (180°)', () => {
      // GIVEN
      factory.placeMachine(5, 5, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(2, 2, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 2, z: 2 },
            path: [{ x: 5, z: 5 }, { x: 4, z: 5 }, { x: 4, z: 4 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 4, z: 1 }, { x: 3, z: 1 }, { x: 2, z: 1 }, { x: 2, z: 2 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(5, 5, 4, 5), seg(4, 5, 4, 4), seg(4, 4, 4, 3), seg(4, 3, 4, 2), seg(4, 2, 4, 1), seg(4, 1, 3, 1), seg(3, 1, 2, 1), seg(2, 1, 2, 2)])
    ...
    it('L-shaped +X then -Z: source faces +X (90°), target faces -Z (180°)', () => {
      ...
      factory.placeMachine(4, 2, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 5 },
            destination: { x: 4, z: 2 },
            path: [{ x: 1, z: 5 }, { x: 2, z: 5 }, { x: 2, z: 4 }, { x: 2, z: 3 }, { x: 2, z: 2 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 4, z: 2 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(1, 5, 2, 5), seg(2, 5, 2, 4), seg(2, 4, 2, 3), seg(2, 3, 2, 2), seg(2, 2, 2, 1), seg(2, 1, 3, 1), seg(3, 1, 4, 1), seg(4, 1, 4, 2)])
    ...
    it('L-shaped -X then +Z: source faces -X (270°), target faces +Z (0°)', () => {
      ...
      factory.placeMachine(2, 4, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | |A| | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 1 },
            destination: { x: 2, z: 4 },
            path: [{ x: 5, z: 1 }, { x: 4, z: 1 }, { x: 3, z: 1 }, { x: 2, z: 1 }, { x: 2, z: 2 }, { x: 2, z: 3 }, { x: 2, z: 4 }],
          },
        ],
      })
    ...
    it('straight +X belt chain: both face +X (90°)', () => {
      ...
      factory.placeMachine(5, 3, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 3 },
            destination: { x: 5, z: 3 },
            path: [{ x: 1, z: 3 }, { x: 2, z: 3 }, { x: 2, z: 2 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 5, z: 3 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(1, 3, 2, 3), seg(2, 3, 2, 2), seg(2, 2, 3, 2), seg(3, 2, 4, 2), seg(4, 2, 5, 2), seg(5, 2, 5, 3)])
    ...
    it('straight -X belt chain: both face -X (270°)', () => {
        ...
        belts: [
          {
            source: { x: 5, z: 3 },
            destination: { x: 1, z: 3 },
            path: [{ x: 5, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 3, z: 2 }, { x: 2, z: 2 }, { x: 1, z: 2 }, { x: 1, z: 3 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(5, 3, 4, 3), seg(4, 3, 4, 2), seg(4, 2, 3, 2), seg(3, 2, 2, 2), seg(2, 2, 1, 2), seg(1, 2, 1, 3)])
    ...
    it('straight +Z belt chain: both face +Z (0°)', () => {
      ...
      factory.placeMachine(3, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | |A| | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 1 },
            destination: { x: 3, z: 5 },
            path: [{ x: 3, z: 1 }, { x: 3, z: 2 }, { x: 3, z: 3 }, { x: 3, z: 4 }, { x: 3, z: 5 }],
          },
        ],
      })
    ...
    it('straight -Z belt chain: both face -Z (180°)', () => {
      // GIVEN
      factory.placeMachine(3, 5, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(3, 1, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | |P| | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 3, z: 1 },
            path: [{ x: 3, z: 5 }, { x: 3, z: 4 }, { x: 4, z: 4 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 4, z: 1 }, { x: 4, z: 0 }, { x: 3, z: 0 }, { x: 3, z: 1 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(3, 5, 3, 4), seg(3, 4, 4, 4), seg(4, 4, 4, 3), seg(4, 3, 4, 2), seg(4, 2, 4, 1), seg(4, 1, 4, 0), seg(4, 0, 3, 0), seg(3, 0, 3, 1)])
    ...
    it('should use Z-first path when X-first would collide', () => {
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 4, z: 4 },
            path: [{ x: 1, z: 1 }, { x: 1, z: 2 }, { x: 2, z: 2 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 4, z: 3 }, { x: 4, z: 4 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(1, 1, 1, 2), seg(1, 2, 2, 2), seg(2, 2, 3, 2), seg(3, 2, 4, 2), seg(4, 2, 4, 3), seg(4, 3, 4, 4)])
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
    ...
    it('should produce correct rotations for Z-first with negative directions', () => {
      ...
      factory.placeMachine(3, 5, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 2, z: 2 },
            path: [{ x: 5, z: 5 }, { x: 5, z: 4 }, { x: 5, z: 3 }, { x: 5, z: 2 }, { x: 5, z: 1 }, { x: 4, z: 1 }, { x: 3, z: 1 }, { x: 2, z: 1 }, { x: 2, z: 2 }],
          },
        ],
      })
      ...
      expect(factory.getMachineAt(2, 2)!.rotation).toBe('south')
      expectBeltSegments(factory, [seg(5, 5, 5, 4), seg(5, 4, 5, 3), seg(5, 3, 5, 2), seg(5, 2, 5, 1), seg(5, 1, 4, 1), seg(4, 1, 3, 1), seg(3, 1, 2, 1), seg(2, 1, 2, 2)])
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
    ...
    it('should not affect straight-line paths (X-first and Z-first identical)', () => {
      ...
      // THEN — Straight +X line with target rotation preserved: planner
      // produces an L-route because both machines face 'south' initially and
      // the target rotation must not be auto-rotated.
      expectBeltSegments(factory, [seg(1, 3, 2, 3), seg(2, 3, 2, 2), seg(2, 2, 3, 2), seg(3, 2, 4, 2), seg(4, 2, 5, 2), seg(5, 2, 5, 3)])
      expect(factory.getMachineAt(1, 3)!.rotation).toBe('east') // source auto-rotated +X
      expect(factory.getMachineAt(5, 3)!.rotation).toBe('south') // target rotation preserved
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
    ...
    it('should not create crossing belts when slot segments cross existing belts', () => {
      ...
      factory.placeMachine(3, 6, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 3, z: 3 },
            destination: { x: 5, z: 4 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 5, z: 3 }, { x: 5, z: 4 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 5, z: 5 },
            path: [{ x: 1, z: 1 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
    ...
    it('should produce valid belt chain with BFS-routed path', () => {
      ...
      factory.placeMachine(0, 3, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '|A| | |R| | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 0, z: 0 },
            destination: { x: 5, z: 5 },
            path: [{ x: 0, z: 0 }, { x: 1, z: 0 }, { x: 2, z: 0 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 6, z: 6 },
            path: [{ x: 2, z: 2 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 6, z: 2 }, { x: 6, z: 3 }, { x: 6, z: 4 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 6, z: 6 },
            path: [{ x: 2, z: 2 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 5, z: 1 }, { x: 6, z: 1 }, { x: 6, z: 2 }, { x: 6, z: 3 }, { x: 6, z: 4 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 3, z: 6 },
            path: [{ x: 3, z: 3 }, { x: 2, z: 3 }, { x: 2, z: 4 }, { x: 3, z: 4 }, { x: 3, z: 5 }, { x: 3, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 3, z: 6 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 4 }, { x: 3, z: 4 }, { x: 3, z: 5 }, { x: 3, z: 6 }],
          },
        ],
      })
    ...
    it('should maintain valid belt path when reconnecting after move', () => {
      // GIVEN
      const assembler = factory.placeMachine(1, 1, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
      ...
      const painter = factory.placeMachine(5, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 1 },
            destination: { x: 5, z: 5 },
            path: [{ x: 3, z: 1 }, { x: 4, z: 1 }, { x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 6, z: 5 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 5, z: 3 }, { x: 6, z: 3 }, { x: 6, z: 4 }, { x: 6, z: 5 }],
          },
        ],
      })
    ...
    it('should create valid path for perpendicular slot arrangements with existing belts', () => {
      ...
      factory.placeMachine(3, 0, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | |A| | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 0 },
            destination: { x: 3, z: 3 },
            path: [{ x: 3, z: 0 }, { x: 3, z: 1 }, { x: 3, z: 2 }, { x: 3, z: 3 }],
          },
        ],
      })

      // B at (6,3) — connect to distant dummy to lock B's rotation to east
      factory.placeMachine(6, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | |A| | | | | | | | | | | |',
            '| | | |│| | | | | | | | | | | |',
      ...
      factory.placeMachine(9, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | |A| | | | | | | | | | | |',
            '| | | |│| | | | | | | | | | | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 6, z: 3 },
            destination: { x: 9, z: 3 },
            path: [{ x: 6, z: 3 }, { x: 7, z: 3 }, { x: 8, z: 3 }, { x: 9, z: 3 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 3, z: 3 },
            destination: { x: 6, z: 3 },
            path: [{ x: 3, z: 3 }, { x: 3, z: 4 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 5, z: 3 }, { x: 6, z: 3 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 6, z: 3 },
            destination: { x: 6, z: 6 },
            path: [{ x: 6, z: 3 }, { x: 6, z: 4 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 3, z: 3 },
            destination: { x: 6, z: 3 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 5, z: 3 }, { x: 6, z: 3 }],
          },
        ],
      })
    ...
    it('should find path around obstacle when direct route is blocked', () => {
      ...
      factory.placeMachine(6, 3, 'part_fabricator', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      factory.placeMachine(5, 3, 'painter', 'south') // blocker between A and B
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
    ...
    it('should produce direct path for horizontally adjacent machines', () => {
      ...
      factory.placeMachine(4, 3, 'part_fabricator', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 4, z: 3 },
            path: [{ x: 3, z: 3 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 4, z: 3 }],
          },
        ],
      })
      ...
      const belts = factory.getBelts()
      expect(belts).toHaveLength(1)
      expect(belts[0].path).toEqual([{ x: 3, z: 3 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 4, z: 3 }])
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
    ...
    it('should NOT produce U-turn for adjacent machines with auto-rotation', () => {
      ...
      factory.placeMachine(3, 3, 'part_fabricator', 'south')  // default south
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(4, 3, 'part_fabricator', 'south')  // default south
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 6, z: 3 },
            path: [{ x: 3, z: 3 }, { x: 3, z: 4 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 5, z: 3 }, { x: 5, z: 2 }, { x: 6, z: 2 }, { x: 6, z: 3 }],
          },
        ],
      })
    ...
    it('should NOT produce U-turn when moveMachine places source adjacent to target', () => {
      ...
      factory.placeMachine(2, 3, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 3 },
            destination: { x: 5, z: 3 },
            path: [{ x: 2, z: 3 }, { x: 3, z: 3 }, { x: 3, z: 2 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 5, z: 3 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 5, z: 3 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 5, z: 3 }],
          },
        ],
      })
      ...
      const belts = factory.getBelts()
      expect(belts).toHaveLength(1)
      expect(belts[0].path).toEqual([{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 5, z: 3 }])
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
    ...
    it('should NOT U-turn when two south-facing machines are connected by placeBeltChain', () => {
      ...
      factory.placeMachine(5, 3, 'splitter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(5, 5, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should not U-turn when machines 3 apart have same rotation and are reconnected with fixedRotations', () => {
      ...
      factory.placeBeltChain(factory.getMachineAt(3, 3)!, factory.getMachineAt(6, 3)!, 'output', { fixedRotations: true })
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should not U-turn when connecting two machines 3 cells apart with auto-rotation', () => {
      ...
      const belts = factory.getBelts()
      expect(belts).toHaveLength(1)
      expect(belts[0].path).toEqual([{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 4, z: 2 }, { x: 5, z: 2 }, { x: 6, z: 2 }, { x: 6, z: 3 }])
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 3 },
            destination: { x: 5, z: 5 },
            path: [{ x: 3, z: 3 }, { x: 4, z: 3 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 8, z: 5 },
            destination: { x: 5, z: 8 },
            path: [{ x: 8, z: 5 }, { x: 8, z: 6 }, { x: 7, z: 6 }, { x: 6, z: 6 }, { x: 5, z: 6 }, { x: 5, z: 7 }, { x: 5, z: 8 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 8, z: 6 },
            destination: { x: 5, z: 8 },
            path: [{ x: 8, z: 6 }, { x: 8, z: 7 }, { x: 7, z: 7 }, { x: 6, z: 7 }, { x: 5, z: 7 }, { x: 5, z: 8 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 6, z: 5 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 8, z: 4 }, { x: 8, z: 5 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 8, z: 4 }, { x: 8, z: 5 }],
          },
        ],
      })
      expect(factory.getMachineAt(5, 5)!.rotation).toBe('north')
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 4, z: 5 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 8, z: 4 }, { x: 8, z: 5 }],
          },
        ],
      })
  ...
  describe('placeMachine()', () => {
    it('should place a machine on an empty cell', () => {
      ...
      // WHEN
      const result = factory.placeMachine(1, 1, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '| | | | | |',
            '| |A| | | |',
    ...
    it('should fail to place on an occupied cell', () => {
      ...
      // WHEN
      const result = factory.placeMachine(1, 1, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '| | | | | |',
            '| |A| | | |',
    ...
    it('should fail to place out of bounds', () => {
      // WHEN + THEN
      expect(factory.placeMachine(-1, 0, 'assembler', 'south')).toBeNull()
      expect(factory.placeMachine(0, 5, 'assembler', 'south')).toBeNull()
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '| | | | | |',
            '| | | | | |',
  ...
  describe('removeBeltById()', () => {
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 5, z: 1 },
            destination: { x: 5, z: 5 },
            path: [{ x: 5, z: 1 }, { x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
    ...
    it('can find belt at cell, then remove it', () => {
      ...
      factory.placeMachine(2, 6, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 2, z: 6 },
            path: [{ x: 2, z: 2 }, { x: 2, z: 3 }, { x: 2, z: 4 }, { x: 2, z: 5 }, { x: 2, z: 6 }],
          },
        ],
      })
  ...
  describe('removeMachine()', () => {
    ...
    it('should remove all chains when machine has belts going to multiple machines', () => {
      ...
      factory = createTestFactory(10, 10)
      factory.placeMachine(4, 4, 'splitter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      factory.placeMachine(4, 7, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 4, z: 4 },
            destination: { x: 1, z: 4 },
            path: [{ x: 4, z: 4 }, { x: 3, z: 4 }, { x: 3, z: 3 }, { x: 2, z: 3 }, { x: 1, z: 3 }, { x: 1, z: 4 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 4, z: 4 },
            destination: { x: 4, z: 7 },
            path: [{ x: 4, z: 4 }, { x: 4, z: 5 }, { x: 4, z: 6 }, { x: 4, z: 7 }],
          },
        ],
      })
      ...
      expectBeltSegments(factory, [seg(4, 4, 3, 4), seg(3, 4, 3, 3), seg(3, 3, 2, 3), seg(2, 3, 1, 3), seg(1, 3, 1, 4), seg(4, 4, 4, 5), seg(4, 5, 4, 6), seg(4, 6, 4, 7)])
    ...
    it('should NOT affect belts between unrelated machines when removing a machine', () => {
      ...
      factory.placeMachine(7, 1, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |A| | | | | |R| | |',
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 7, z: 1 },
            destination: { x: 7, z: 4 },
            path: [{ x: 7, z: 1 }, { x: 7, z: 2 }, { x: 7, z: 3 }, { x: 7, z: 4 }],
          },
        ],
      })
  ...
  describe('rotateMachine()', () => {
    it('should maintain valid belt after rotation', () => {
      ...
      const assembler = factory.placeMachine(2, 2, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '| | | | | |',
            '| | | | | |',
      ...
      const painter = factory.placeMachine(3, 3, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 4, 4], expected: [
            '| | | | | |',
            '| | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 3, z: 3 },
            path: [{ x: 2, z: 2 }, { x: 2, z: 1 }, { x: 3, z: 1 }, { x: 3, z: 2 }, { x: 3, z: 3 }],
          },
        ],
      })
    ...
    it('should rotate to east and reconnect belt', () => {
      ...
      const painter = factory.placeMachine(6, 6, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 4, z: 4 },
            destination: { x: 6, z: 6 },
            path: [{ x: 4, z: 4 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 4, z: 4 },
            destination: { x: 6, z: 6 },
            path: [{ x: 4, z: 4 }, { x: 4, z: 5 }, { x: 5, z: 5 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 4, z: 4 },
            destination: { x: 6, z: 6 },
            path: [{ x: 4, z: 4 }, { x: 3, z: 4 }, { x: 3, z: 5 }, { x: 4, z: 5 }, { x: 5, z: 5 }, { x: 6, z: 5 }, { x: 6, z: 6 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 6, z: 5 }, { x: 6, z: 6 }, { x: 7, z: 6 }, { x: 8, z: 6 }, { x: 8, z: 5 }],
          },
        ],
      })
    ...
    it('DIAG: reproduce screenshot U-turn after multiple rotations', () => {
      ...
      factory.placeMachine(5, 7, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      factory.placeMachine(8, 7, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 7 },
            destination: { x: 8, z: 7 },
            path: [{ x: 5, z: 7 }, { x: 6, z: 7 }, { x: 6, z: 6 }, { x: 7, z: 6 }, { x: 8, z: 6 }, { x: 8, z: 7 }],
          },
        ],
      })
        ...
        belts: [
          {
            source: { x: 5, z: 7 },
            destination: { x: 8, z: 7 },
            path: [{ x: 5, z: 7 }, { x: 4, z: 7 }, { x: 4, z: 6 }, { x: 5, z: 6 }, { x: 6, z: 6 }, { x: 7, z: 6 }, { x: 8, z: 6 }, { x: 8, z: 7 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        machines: [
          { x: 5, z: 7, rotation: 'west' },
          { x: 8, z: 7, rotation: 'north' },
        ],
        belts: [
          {
            source: { x: 5, z: 7 },
            destination: { x: 8, z: 7 },
            path: [{ x: 5, z: 7 }, { x: 4, z: 7 }, { x: 4, z: 8 }, { x: 5, z: 8 }, { x: 6, z: 8 }, { x: 7, z: 8 }, { x: 8, z: 8 }, { x: 8, z: 7 }],
          },
        ],
      })
    ...
    it('should produce short belt through valid slots after rotating destination machine', () => {
      ...
      expect(factory.getMachineAt(8, 7)!.rotation).toBe('south')
  ...
  describe('updateMachineType()', () => {
    ...
    it('should preserve machine position and id after type change', () => {
      // GIVEN
      factory.placeMachine(4, 4, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should regenerate the auto-name when the current name is the default auto-name for the old type', () => {
      ...
      factory.placeMachine(3, 3, 'part_fabricator', 'south')
      expect(factory.getMachineAt(3, 3)!.name).toBe('PartFabricator1')
      ...
      expect(machine.name).toBe('FactoryOutput1')
    })
    ...
    it('should advance the per-type counter when regenerating the auto-name', () => {
      ...
      expect(factory.getMachineAt(5, 1)!.name).toBe('FactoryOutput1')

      // WHEN — change one of the fabricators' type to factory_output.
      factory.updateMachineType(2, 1, 'factory_output')

      // THEN — the next auto-name for factory_output is "FactoryOutput2".
      expect(factory.getMachineAt(2, 1)!.name).toBe('FactoryOutput2')
    })
  ...
  describe('slot-blocking placement constraint', () => {
    ...
    it('should reject placing a machine directly in front of another machine\'s output slot', () => {
      ...
      const result = factory.placeMachine(5, 6, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should reject placing a machine directly behind another machine (blocking its input slot)', () => {
      ...
      const result = factory.placeMachine(5, 4, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should allow placing a machine on the side (not in front of any slot)', () => {
      ...
      const result = factory.placeMachine(6, 5, 'recycler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should reject splitter placement adjacent to any existing machine (all 4 neighbors blocked)', () => {
      ...
      const result = factory.placeMachine(5, 5, 'splitter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should reject assembler placement adjacent to any existing machine (all 4 neighbors blocked)', () => {
      ...
      factory.placeMachine(5, 6, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const result = factory.placeMachine(5, 5, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should reject placing a regular machine in front of a splitter\'s side output slot', () => {
      ...
      const result = factory.placeMachine(6, 5, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should allow placing a machine 2 cells away (not directly adjacent to slots)', () => {
      ...
      const result = factory.placeMachine(5, 7, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should skip rotation that makes a slot face a neighbor and use next valid CW rotation', () => {
      ...
      const machine = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should always succeed rotation when no neighbors exist', () => {
      ...
      const machine = factory.placeMachine(5, 5, 'assembler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
  ...
  describe('canMoveMachine()', () => {
    ...
    it('should return false when target cell has a machine', () => {
      ...
      factory.placeMachine(7, 7, 'painter', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should return false when move would drop a belt (no valid reconnection path)', () => {
      ...
      const b = factory.placeMachine(3, 1, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| |F| |F| | | | | | |',
        ...
        belts: [
          {
            source: { x: 1, z: 1 },
            destination: { x: 3, z: 1 },
            path: [{ x: 1, z: 1 }, { x: 2, z: 1 }, { x: 2, z: 0 }, { x: 3, z: 0 }, { x: 3, z: 1 }],
          },
        ],
      })
      ...
      factory.placeMachine(7, 8, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(8, 7, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(8, 9, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(9, 8, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(7, 7, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(7, 9, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(9, 7, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
      ...
      factory.placeMachine(9, 9, 'assembler', 'south')
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | |┌|┐| | | | | | |',
            '| |F|┘|F| | | | | | |',
    ...
    it('should return true when move preserves all belt connections', () => {
      ...
      factory = createTestFactory(10, 10)
      const a = factory.placeMachine(2, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const b = factory.placeMachine(5, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 2, z: 2 },
            destination: { x: 5, z: 2 },
            path: [{ x: 2, z: 2 }, { x: 3, z: 2 }, { x: 3, z: 1 }, { x: 4, z: 1 }, { x: 5, z: 1 }, { x: 5, z: 2 }],
          },
        ],
      })
  ...
  describe('placeBeltChain() with fixedRotations', () => {
    ...
    it('should not rotate machines when fixedRotations is true', () => {
      ...
      const left = factory.placeMachine(3, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const right = factory.placeMachine(4, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const result = factory.placeBeltChain(left, right, 'output', { fixedRotations: true })
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 4, z: 5 },
            path: [{ x: 3, z: 5 }, { x: 3, z: 4 }, { x: 4, z: 4 }, { x: 4, z: 5 }],
          },
        ],
      })
  ...
  describe('computePlacementPlan input-slot routing', () => {
    ...
    it('should auto-rotate assembler source to present an input toward the fabricator while preserving the fabricator target rotation', () => {
      ...
      const assembler = factory.placeMachine(3, 5, 'assembler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const fabricator = factory.placeMachine(7, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 7, z: 5 },
            destination: { x: 3, z: 5 },
            path: [{ x: 7, z: 5 }, { x: 7, z: 6 }, { x: 6, z: 6 }, { x: 5, z: 6 }, { x: 4, z: 6 }, { x: 4, z: 5 }, { x: 3, z: 5 }],
          },
        ],
      })
      ...
      // The fabricator's rotation MUST be preserved at its initial value
      // ('south'), never auto-rotated by the planner.
      expect(fabricator.rotation).toBe('south')
    ...
    it('should route belt from fabricator output to assembler left input when assembler already has one belt connected, preserving the fabricator target rotation', () => {
      // GIVEN: assembler at (5,5) with default rotation 'south'
      const assembler = factory.placeMachine(5, 5, 'assembler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const helperFab = factory.placeMachine(5, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 2 },
            destination: { x: 5, z: 5 },
            path: [{ x: 5, z: 2 }, { x: 5, z: 3 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })
      ...
      const standaloneFab = factory.placeMachine(5, 8, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      // The standalone fabricator's rotation MUST be preserved at its
      // initial value ('south'), never auto-rotated by the planner.
      expect(standaloneFab.rotation).toBe('south')
  ...
  describe('placeBeltChain auto-rotation fallback', () => {
    ...
    it('should preserve machine rotations with fixedRotations=true', () => {
      ...
      const machineA = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
      ...
      const machineB = factory.placeMachine(5, 8, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      const result = factory.placeBeltChain(machineA, machineB, 'output', { fixedRotations: true })
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
    ...
    it('should auto-rotate unconnected machines when fixedRotations is false', () => {
      ...
      const machineB = factory.placeMachine(8, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
    ...
    it('should produce shorter belt path with auto-rotation than with fixed rotations', () => {
      ...
      const mA1 = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      const mB1 = factory.placeMachine(7, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      // WHEN — place with fixedRotations=true
      const fixedResult = factory.placeBeltChain(mA1, mB1, 'output', { fixedRotations: true })
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 7, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 5, z: 6 }, { x: 6, z: 6 }, { x: 6, z: 5 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 7, z: 5 }],
          },
        ],
      })
      ...
      factory = createTestFactory(20, 20)
      const mA2 = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      const mB2 = factory.placeMachine(7, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 7, z: 5 },
            path: [{ x: 5, z: 5 }, { x: 6, z: 5 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 7, z: 5 }],
          },
        ],
      })
    ...
    it('should succeed with auto-rotation when machines face away from each other on same column', () => {
      ...
      const machineB = factory.placeMachine(5, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 5, z: 5 },
            destination: { x: 5, z: 2 },
            path: [{ x: 5, z: 5 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 6, z: 3 }, { x: 6, z: 2 }, { x: 6, z: 1 }, { x: 5, z: 1 }, { x: 5, z: 2 }],
          },
        ],
      })
    ...
    it('should rotate source output toward destination with auto-rotation', () => {
      ...
      const machineA = factory.placeMachine(3, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 3, z: 5 }, { x: 4, z: 5 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 6, z: 4 }, { x: 7, z: 4 }, { x: 8, z: 4 }, { x: 8, z: 5 }],
          },
        ],
      })
  ...
  describe('placeBeltChain slot type validation', () => {
    ...
    it('should reject belt where source slot resolves to an input slot', () => {
      ...
      const shipper = factory.placeMachine(2, 2, 'factory_output', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const fabricator = factory.placeMachine(2, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should reject belt creating input-to-input connection', () => {
      ...
      const shipperA = factory.placeMachine(2, 2, 'factory_output', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const shipperB = factory.placeMachine(2, 5, 'factory_output', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should allow valid output-to-input connection', () => {
      ...
      const fabricator = factory.placeMachine(2, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
      ...
      const shipper = factory.placeMachine(2, 5, 'factory_output', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 9, 9], expected: [
            '| | | | | | | | | | |',
            '| | | | | | | | | | |',
    ...
    it('should fail with sourceSlotType=input when target has no outputs (Shipper)', () => {
      ...
      factory = createTestFactory(15, 15)
      const fabricator = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const shipper = factory.placeMachine(8, 5, 'factory_output', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
    ...
    it('should succeed with reverse slot type when first belt exists', () => {
      ...
      const fabricatorA = factory.placeMachine(8, 8, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        machines: [
          { x: 8, z: 5, rotation: 'south' },
          { x: 8, z: 8, rotation: 'south' },
        ],
        belts: [
        ],
      })
      const fabricatorB = factory.placeMachine(12, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
        ...
        belts: [
          {
            source: { x: 8, z: 8 },
            destination: { x: 8, z: 5 },
            path: [{ x: 8, z: 8 }, { x: 8, z: 7 }, { x: 8, z: 6 }, { x: 8, z: 5 }],
          },
        ],
      })
      ...
      expectFactoryState(factory, {
        ...
        belts: [
          ...
          },
          {
            source: { x: 12, z: 5 },
            destination: { x: 8, z: 5 },
            path: [{ x: 12, z: 5 }, { x: 11, z: 5 }, { x: 10, z: 5 }, { x: 9, z: 5 }, { x: 8, z: 5 }],
          },
        ],
      })
      ...
      expect(renderGrid(factory, 6, 3, 14, 10)).toBe([
        '| | | | | | | | | |',
        '| | | | | | | | | |',
        '| | |O|─|─|─|F| | |',
        '| | |│| | | | | | |',
  ...
  describe('placeBeltChain slot freedom validation', () => {
    it('should return null or colliding when both machines have no free slots for the requested type', () => {
      ...
      const fabA = factory.placeMachine(8, 8, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      const fabB = factory.placeMachine(12, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
    ...
    it('should auto-rotate fabricator when connecting with placeBeltChain', () => {
      ...
      const fab = factory.placeMachine(12, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 19, 19], expected: [
            '| | | | | | | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | | | | | | |',
      ...
      // Verify grid shows the connection
      expect(renderGrid(factory, 6, 3, 14, 7)).toBe([
        '| | | | | | | | | |',
        '| | | | | | | | | |',
        '| | |O|─|─|─|F| | |',
        '| | | | | | | | | |',
  ...
  describe('targetSlotPosition constraint', () => {
    ...
    describe('computeBeltFromSlotPath()', () => {
      it('should constrain path to end at back input slot of Shipper when targetSlotPosition=back', () => {
        ...
        const fab = factory.placeMachine(5, 8, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        const shipper = factory.placeMachine(5, 5, 'factory_output', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        const result = factory.computeBeltFromSlotPath({ x: 5, z: 8 }, { x: 5, z: 5 }, 'output', { targetSlotPosition: 'back' })
      ...
      it('should constrain path to end at right input slot of Shipper when targetSlotPosition=right', () => {
        ...
        const fab = factory.placeMachine(5, 5, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
      ...
      it('should constrain Assembler path to left input slot when targetSlotPosition=left', () => {
        ...
        const fab = factory.placeMachine(8, 5, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
      ...
      it('should use slot at current rotation, not auto-rotated rotation, when targetSlotPosition is provided', () => {
        ...
        const result = factory.computeBeltFromSlotPath({ x: 5, z: 5 }, { x: 8, z: 5 }, 'output', { targetSlotPosition: 'front' })
    ...
    describe('placeBeltChain()', () => {
      it('should connect belt to specified target slot on Shipper', () => {
        ...
        const result = factory.placeBeltChain(fab, shipper, 'output', { targetSlotPosition: 'back' })
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
          ...
          belts: [
            {
              source: { x: 5, z: 8 },
              destination: { x: 5, z: 5 },
              path: [{ x: 5, z: 8 }, { x: 5, z: 7 }, { x: 6, z: 7 }, { x: 6, z: 6 }, { x: 6, z: 5 }, { x: 6, z: 4 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
            },
          ],
        })
      ...
      it('should still auto-rotate SOURCE machine when targetSlotPosition is provided', () => {
        ...
        const assembler = factory.placeMachine(8, 5, 'assembler', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        const result = factory.placeBeltChain(fab, assembler, 'output', { targetSlotPosition: 'back' })
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
  ...
  /**
   * NEW BEHAVIOR (RED): An explicit `targetSlotPosition` is now a *preference*,
   * not a hard constraint. If no valid belt can be placed using the explicit
   * target slot (wrong type / occupied / unreachable), the system must fall
   * back to machine-body-mode target-slot picking — the closest free
   * complementary slot on the SAME target machine.
   *
   * The reverse-slot last-resort fallback (flipping source/target and slot
   * direction) must NOT fire when a valid same-direction sibling slot is
   * available on the target machine.
   *
   * The happy path (explicit slot is reachable + correct type + free) is
   * already covered by the `targetSlotPosition constraint` describe block
   * above and MUST keep terminating at the requested slot.
   */
  describe('slot-targeted fallback', () => {
    beforeEach(() => {
      factory = createTestFactory(15, 15)
    })

    it('(a) should fall back to a free complementary input slot when the requested target slot is the WRONG TYPE (output instead of input)', () => {
      // GIVEN: Splitter at (5,5) facing south. Splitter inputs: ['back']
      // (only one input slot). Splitter outputs: 'front'=(5,6), 'right'=(6,5),
      // 'left'=(4,5). Source fabricator placed two cells west at (3,5). The
      // user is dragging from the fab's OUTPUT and the cursor is over the
      // splitter's 'left' cell at (4,5) — but 'left' on a splitter is an
      // OUTPUT slot, so the splitter cannot accept an incoming belt there.
      //
      // The direct path from (3,5) to (5,5) naturally enters the splitter at
      // (4,5)='left' — exactly the requested cell — but that is the wrong
      // slot type. New behavior: fall back to the only free complementary
      // input slot 'back' at (5,4).
      const fab = factory.placeMachine(3, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const splitter = factory.placeMachine(5, 5, 'splitter', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      // ASSERT
      expect(renderGrid(factory, 2, 4, 6, 6)).toBe([
        '| | | | | |',
        '| |F| |S| |',
        '| | | | | |',
      ].join('\n'))

      // WHEN: Place belt with targetSlotPosition='left' (the wrong type).
      // tryReverseSlotType=true so we can also assert the reverse-slot fallback
      // does NOT fire — it must prefer a same-direction sibling input slot.
      const result = factory.placeBeltChain(fab, splitter, 'output', {
        ...
        belts: [
          {
            source: { x: 3, z: 5 },
            destination: { x: 5, z: 5 },
            path: [{ x: 3, z: 5 }, { x: 4, z: 5 }, { x: 4, z: 4 }, { x: 5, z: 4 }, { x: 5, z: 5 }],
          },
        ],
      })

      // THEN: Belt must be placed (fallback to splitter's only free input
      // slot 'back').
      expect(result).toBe(true)
      const belts = factory.getBelts()
      expect(belts).toHaveLength(1)
      ...
      // Reverse-slot fallback did NOT fire: source is still fab (output),
      // destination is still splitter (input).
      expect(belt.sourceMachine.id).toBe(fab.id)
      expect(belt.destinationMachine.id).toBe(splitter.id)
      expect(fab.slots.outputs).toContain(belt.sourceSlot)
      expect(splitter.slots.inputs).toContain(belt.destinationSlot)
      expect(belt.destinationSlot).toBe('back')

      // Penultimate cell must be the 'back' slot cell (5,4), NOT the
      // requested 'left' cell (4,5).
      const penultimate = belt.path[belt.path.length - 2]
      expect(penultimate).toEqual({ x: 5, z: 4 })
      expect(penultimate).not.toEqual({ x: 4, z: 5 })
      expect(belt.path[belt.path.length - 1]).toEqual({ x: 5, z: 5 })
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
    ...
    it('(b) should fall back to a free sibling input slot when the requested target slot is OCCUPIED by another belt', () => {
      // GIVEN: Assembler at (5,5) south. Inputs: back=(5,4), right=(6,5),
      // left=(4,5). First fabricator south of assembler connects to its
      // 'back' slot, occupying the back input AND locking the assembler's
      // rotation to 'south'. Second fabricator placed NORTH of the assembler
      // — the direct path from there enters the assembler at (5,6)='front',
      // which is the assembler's OUTPUT slot (wrong type), so today the
      // colliding-fallback also fails to honor the request.
      const fab1 = factory.placeMachine(5, 2, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const fab2 = factory.placeMachine(5, 8, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      expect(fab1).not.toBeNull()
      expect(assembler).not.toBeNull()
      expect(fab2).not.toBeNull()

      const firstResult = factory.placeBeltChain(fab1, assembler, 'output', { targetSlotPosition: 'back' })
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const firstBelts = factory.getBelts()
      expect(firstBelts).toHaveLength(1)
      // Sanity: the existing belt connects to the 'back' slot of the assembler.
      expect(firstBelts[0].destinationSlot).toBe('back')
      expect(firstBelts[0].path[firstBelts[0].path.length - 2]).toEqual({ x: 5, z: 4 })
      expect(assembler.rotation).toBe('south')

      // ASSERT: snapshot of grid before the second placement
      expect(renderGrid(factory, 4, 1, 6, 9)).toBe([
        '| | | |',
        '| |F| |',
        '| |│| |',
        '| |│| |',
      ...
      // WHEN: Try to place a second belt also requesting 'back' on the same
      // assembler. 'back' is the right type but is already occupied. The
      ...
      // THEN: Belt must be placed via a free sibling input slot ('right' or
      // 'left'), NOT 'back', NOT 'front' (which is an output).
      expect(result).toBe(true)
      const belts = factory.getBelts()
      expect(belts).toHaveLength(2)
      const secondBelt = belts.find(b => b.sourceMachine.id === fab2.id)!
      expect(secondBelt).toBeDefined()
      expect(secondBelt.destinationMachine.id).toBe(assembler.id)
      expect(secondBelt.destinationSlot).not.toBe('back')
      expect(assembler.slots.inputs).toContain(secondBelt.destinationSlot)
      expect(['right', 'left']).toContain(secondBelt.destinationSlot)

      const penultimate = secondBelt.path[secondBelt.path.length - 2]
      expect(penultimate).not.toEqual({ x: 5, z: 4 })
      expect(penultimate).not.toEqual({ x: 5, z: 6 })
      // Sibling input cell must be (6,5) ('right') or (4,5) ('left').
      const isRightCell = penultimate.x === 6 && penultimate.z === 5
      const isLeftCell = penultimate.x === 4 && penultimate.z === 5
      expect(isRightCell || isLeftCell).toBe(true)
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
    ...
    it('(c) should fall back to a reachable sibling input slot when the requested target slot is UNREACHABLE', () => {
      // GIVEN: Assembler at (5,5) south. Inputs: back=(5,4), right=(6,5),
      // left=(4,5). The 'back' slot cell (5,4) is the right type and free,
      // but it is walled off by surrounding machines on every entry side
      // ((4,4), (5,3), (6,4)). The 'left' slot at (4,5) remains reachable
      // from a fabricator placed to the west.
      const assembler = factory.placeMachine(5, 5, 'assembler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
      ...
      // Walls around (5,4):
      const wallW = factory.placeMachine(4, 4, 'recycler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const wallN = factory.placeMachine(5, 3, 'recycler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      const wallE = factory.placeMachine(6, 4, 'recycler', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      // Source fabricator far to the west on the same row as 'left' slot.
      const fab = factory.placeMachine(1, 5, 'part_fabricator', 'south')!
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
            '| | | | | | | | | | | | | | | |',
      ...
      expect(assembler).not.toBeNull()
      expect(wallW).not.toBeNull()
      expect(wallN).not.toBeNull()
      expect(wallE).not.toBeNull()
      expect(fab).not.toBeNull()

      // ASSERT
      expect(renderGrid(factory, 0, 2, 7, 6)).toBe([
        '| | | | | | | | |',
        '| | | | | |R| | |',
        '| | | | |R| |R| |',
        '| |F| | | |A| | |',
      ...
      // WHEN: Place belt with targetSlotPosition='back'. The 'back' cell (5,4)
      // is unreachable (all four neighbors are blocked except the assembler
      // itself), but 'left' at (4,5) is reachable along the row z=5.
      const result = factory.placeBeltChain(fab, assembler, 'output', {
        targetSlotPosition: 'back',
        tryReverseSlotType: true,
      })
      expectFactoryState(factory, {
        ...
        belts: [
          {
            source: { x: 1, z: 5 },
            destination: { x: 5, z: 5 },
            path: [{ x: 1, z: 5 }, { x: 2, z: 5 }, { x: 3, z: 5 }, { x: 4, z: 5 }, { x: 5, z: 5 }],
          },
        ],
      })

      // THEN: Belt must be placed via the reachable sibling input slot.
      expect(result).toBe(true)
      const belts = factory.getBelts()
      expect(belts).toHaveLength(1)
      const belt = belts[0]
      expect(belt.sourceMachine.id).toBe(fab.id)
      expect(belt.destinationMachine.id).toBe(assembler.id)
      expect(belt.destinationSlot).not.toBe('back')
      expect(['right', 'left']).toContain(belt.destinationSlot)

      const penultimate = belt.path[belt.path.length - 2]
      expect(penultimate).not.toEqual({ x: 5, z: 4 })
      // The reachable sibling along the west approach is 'left' = (4,5).
      expect(penultimate).toEqual({ x: 4, z: 5 })
      assertBeltSlotInvariant(factory)
      expectFactoryState(factory, {
        grid: { box: [0, 0, 14, 14], expected: [
            '| | | | | | | | | | | | | | | |',
    ...
    it('(a, computeBeltFromSlotPath) should return a path ending at a free sibling input slot when the requested target slot is the WRONG TYPE', () => {
      // GIVEN: Same wrong-type setup as (a), exercised via the path-only API
      // used by ghost preview. Today the planner returns a path that enters
      // the splitter at the requested 'left' cell, which fails slot-type
      // validation in `isValidSlotPath` (splitter input is only 'back') — so
      // `computeBeltFromSlotPath` returns null or a colliding result. New
      // behavior returns a valid non-colliding path terminating at the
      // 'back' input cell of the splitter.
      ...
      // WHEN
      const result = factory.computeBeltFromSlotPath(
        { x: 3, z: 5 }, { x: 5, z: 5 }, 'output',
        { targetSlotPosition: 'left', tryReverseSlotType: true },
      )
  ...
  /**
   * Regression tests for the bug where PlacementPlanner.computePlacementPlan
   * ignores which specific source slot the user clicked. When the source
   * machine has multiple input/output slots and is rotation-locked (already
   * has belts), the planner must:
   *   1. Filter source slots to ONLY the user-clicked slot, AND
   *   2. Compute the trial path used for target auto-rotation starting from
   *      the clicked source-slot CELL (not the source machine's center cell).
   *
   * Expected NEW API surface (added by the fix):
   *   factory.computeBeltFromSlotPath(from, to, sourceSlotType,
   *                                   ignoreBeltIds?, fixedRotations?,
   *                                   targetSlotPosition?,
   *                                   sourceSlotPosition? /* NEW *​/)
   *   factory.placeBeltChain(from, to, sourceSlotType,
   *                          fixedRotations?, lockedMachinePos?,
   *                          ignoreBeltIds?, targetSlotPosition?,
   *                          sourceSlotPosition? /* NEW *​/)
   *
   * These tests cast through `any` because the parameter does not yet exist
   * in the current type signatures — so the call passes an extra positional
   * argument that the current implementation silently ignores. That is the
   * exact reason the tests fail on the current code: the source slot
   * constraint is not honored, the planner picks the closest input slot, and
   * the resulting belt connects to the wrong slot of the source machine.
   */
  describe('sourceSlotPosition constraint', () => {
    beforeEach(() => {
      factory = createTestFactory(15, 15)
    })

    describe('computeBeltFromSlotPath()', () => {
      it('should constrain path to enter through right input slot of Assembler when sourceSlotPosition=right', () => {
        // GIVEN: Assembler A at (5,5) south with multiple inputs (back, right, left).
        // A is locked by an existing output belt to fabricator C at (5,7),
        // so its rotation cannot change. Target B (fabricator) at (1,1)
        // (north-west of A) has no belts and may auto-rotate.
        //
        // The user drags from A's RIGHT input slot — cell (6,5) — toward B.
        // Without the new sourceSlotPosition param, the planner picks the
        // closest input slot to B (back at (5,4) or left at (4,5)) instead
        // of the user-clicked 'right' slot.
        const a = factory.placeMachine(5, 5, 'assembler', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        const c = factory.placeMachine(5, 7, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        const b = factory.placeMachine(1, 1, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| |F| | | | | | | | | | | | | |',
        ...
        // Lock A's rotation by connecting its output slot to C
        const connected = factory.placeBeltChain(a, c, 'output')
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| |F| | | | | | | | | | | | | |',
          ...
          belts: [
            {
              source: { x: 5, z: 5 },
              destination: { x: 5, z: 7 },
              path: [{ x: 5, z: 5 }, { x: 5, z: 6 }, { x: 5, z: 7 }],
            },
          ],
        })
        expect(connected).toBe(true)
        expect(factory.machineHasAnyBelts(5, 5)).toBe(true)
        expect(factory.machineHasAnyBelts(1, 1)).toBe(false)

        // ASSERT initial state: A locked by belt to C, B free at (1,1)
        expect(renderGrid(factory, 0, 0, 7, 8)).toBe([
          '| | | | | | | | |',
          '| |F| | | | | | |',
          '| | | | | | | | |',
          '| | | | | | | | |',
        ...
        // WHEN: Compute belt with sourceSlotPosition='right'.
        const result = factory.computeBeltFromSlotPath(
          { x: 5, z: 5 }, { x: 1, z: 1 }, 'input',
      ...
      it('should constrain path to enter through left input slot of Assembler when sourceSlotPosition=left', () => {
        // GIVEN: Same Assembler-locked-to-fabricator setup, but with B placed
        // due-east of A so the closest input is 'right' at (6,5). User
        // explicitly clicks A's 'left' input slot at (4,5).
        const a = factory.placeMachine(5, 5, 'assembler', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
        ...
        const b = factory.placeMachine(12, 5, 'part_fabricator', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| | | | | | | | | | | | | | | |',
        ...
        // ASSERT initial state
        expect(renderGrid(factory, 4, 4, 13, 8)).toBe([
          '| | | | | | | | | | |',
          '| |A| | | | | | |F| |',
          '| |│| | | | | | | | |',
          '| |F| | | | | | | | |',
        ...
        // WHEN: sourceSlotPosition='left'.
        const result = factory.computeBeltFromSlotPath(
          { x: 5, z: 5 }, { x: 12, z: 5 }, 'input',
    ...
    describe('placeBeltChain()', () => {
      it('should connect belt to specified right input slot of Assembler when sourceSlotPosition=right', () => {
        // GIVEN: Assembler A locked by output belt to C; fabricator B at (1,1)
        // with no belts (so B may auto-rotate). User drags from A's 'right'
        // input slot (cell (6,5)) toward B.
        const a = factory.placeMachine(5, 5, 'assembler', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
        ...
        // ASSERT initial state (A→C belt visible, B isolated)
        expect(renderGrid(factory, 0, 0, 7, 8)).toBe([
          '| | | | | | | | |',
          '| |F| | | | | | |',
          '| | | | | | | | |',
        ...
        // THEN: placement succeeds and the new belt connects A's 'right' input
        // (NOT the closest 'back' or 'left' slot).
        expect(ok).toBe(true)
        const belts = factory.getBelts()
        expect(belts).toHaveLength(beltsBefore + 1)
        const newBelt = belts.find((bl) => bl.sourceMachine.id === b.id && bl.destinationMachine.id === a.id)
        ...
        const bOutputOffset = { x: path[1].x - path[0].x, z: path[1].z - path[0].z }
        const bOutputOffsets = newBelt!.sourceMachine.slots.outputs.map((p) =>
          slotPositionToOffset(p, newBelt!.sourceMachine.rotation),
        )
        const bOutputMatches = bOutputOffsets.some((o) => o.x === bOutputOffset.x && o.z === bOutputOffset.z)
        expect(bOutputMatches,
          `B's output slot at rotation=${newBelt!.sourceMachine.rotation} must lie on path[1]; ` +
          `path[1]-path[0]=(${bOutputOffset.x},${bOutputOffset.z}), valid output offsets=${JSON.stringify(bOutputOffsets)}`,
        ).toBe(true)

        // Whole-factory invariant: every belt connects to a valid I/O slot.
        assertBeltSlotInvariant(factory)
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
      ...
      it('should leave A unchanged when sourceSlotPosition refers to a non-existent slot', () => {
        // Defensive test: assembler A has no 'front' input slot (front is its
        // output). Asking the planner to use 'front' as a source INPUT slot
        // must NOT silently fall back to a different slot — it should fail.
        const a = factory.placeMachine(5, 5, 'assembler', 'south')!
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
        ...
        factory.placeBeltChain(a, c, 'output')
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| |F| | | | | | | | | | | | | |',
        ...
        // WHEN: pass an invalid source slot for input (assembler.inputs = back/right/left).
        const ok = factory.placeBeltChain(
          a, b, 'input',
        ...
        // THEN: no new belt should be placed.
        expect(ok).toBe(false)
        expect(factory.getBelts()).toHaveLength(beltsBefore)
        expectFactoryState(factory, {
          grid: { box: [0, 0, 14, 14], expected: [
              '| | | | | | | | | | | | | | | |',
              '| |F| | | | | | | | | | | | | |',
